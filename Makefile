...
bn: 	bn.c tools.o
	gcc -o bn bn.c tools.o

testbn: bn
	./bn 3793615704055510775 6195393205523641517
	@echo '3793615704055510775*6195393205523641517' | bc
	./bn 13952583427285467009 7785943974315773393
	@echo '13952583427285467009*7785943974315773393' | bc
	./bn 5377609446418532635 2322825744161048747
	@echo '5377609446418532635*2322825744161048747' | bc
	./bn 38560285340583048985693485409423 12872394503468994070858532947804889
	@echo '38560285340583048985693485409423*12872394503468994070858532947804889' | bc
	./bn 3856028453453452342 234234234543128723
	@echo '3856028453453452342*234234234543128723' | bc
	./bn 1000000000000000000001 1000000000000000000003
	@echo '1000000000000000000001*1000000000000000000003' | bc
...
test30: test30.o tools.o
	gcc -o test30 test30.o tools.o

test31: test31.o tools.o
	gcc -o test31 test31.o tools.o -lrt

test32: test32.o tools.o
	gcc -o test32 test32.o tools.o -lrt -lm
